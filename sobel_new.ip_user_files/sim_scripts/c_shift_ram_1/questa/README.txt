...
#
# Generated by export_simulation on Sat Oct 16 19:51:20 +0800 2021
#
################################################################################
...
'-reset_run' switch to the './c_shift_ram_1.sh' script.

./c_shift_ram_1.sh -reset_run
...
./c_shift_ram_1.sh -noclean_files

For more information on the script, please type './c_shift_ram_1.sh -help'.
