...
#
# Generated by export_simulation on Wed Oct 20 21:17:13 +0800 2021
#
################################################################################
...
'-reset_run' switch to the './sobel_top.sh' script.

./sobel_top.sh -reset_run
...
./sobel_top.sh -noclean_files

For more information on the script, please type './sobel_top.sh -help'.
